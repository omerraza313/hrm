...
class UpdatePolicyRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'add_policy_off_days.min' => 'Value must be at least 0',
            'add_policy_working_hours.required' => 'Working hours is required',
            'add_policy_shift_hours.required' => 'Shift retaining hours is required',

            'add_policy_shift_start.required' => 'Shift hours are required',
            'add_policy_shift_start.date_format' => 'Shift hours must be in hours (e.g., 9:00 AM)',
            'add_policy_late_c_l_t.required' => 'Late-coming leniency time is required',
            'add_policy_late_c_l_t.numeric' => 'Late-coming leniency time must be numeric',
            ...
            'add_policy_shift_close.required' => 'Shift hours are required',
            'add_policy_shift_close.date_format' => 'Shift hours must be in hours (e.g., 5:00 PM)',
            'add_policy_force_timeout.required' => 'Force Timeout is required',
            'add_policy_force_timeout.in' => 'Please select the correct option for Force Timeout',
            'add_policy_timeout_policy.required' => 'Timeout Policy is required',
            'add_policy_timeout_policy.in' => 'Please select the correct option for Timeout Policy',
            'add_policy_monthly_late_minute.required' => 'Late minute monthly bucket is required',
            'add_policy_monthly_late_minute.numeric' => 'Please insert a numeric value',
            ...
            'add_policy_late_comers_penalty.numeric' => 'Please insert a numeric value',
            ...
            'add_policy_ot_min_minutes.required' => 'Minutes are required',
            ...
            'add_policy_ot_rate_value.numeric' => 'Rate must be a number',
            'add_policy_ot_amount.required' => 'Amount is required',
            'add_policy_ot_amount.numeric' => 'Amount must be a number',
            ...
            'add_policy_holiday_ot_rate.numeric' => 'Rate must be a number',
            'add_policy_holiday_ot_amount.required' => 'Amount is required',
            'add_policy_holiday_ot_amount.numeric' => 'Amount must be a number',
        ];
    }
}
