            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('admin.apply.leave.employee') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select" name="add_leave_employee" id="add_leave_employee"
                            onchange="employeeChangeFunc();">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="add_leave_adjust_plan[]"
                                                    ...
                                                    @php
                                                        $employee_data = \App\Models\User::where('id', old('add_leave_employee'))
                                                            ->with('employee_details')
                                                            ->first();
                                                        $leaves = \App\Models\LeavePlan::whereIn('leave_gender_type', [$employee_data->employee_details->gender, 'both'])->get();
                                                    @endphp
        ...
        function adjustleavedates(ev) {
            ...
            if (toDate >= fromDate) {
                ...
                for (let index = 0; index <= daysDiff; index++) {
                    ...
                    let cDate = currentDate.toLocaleDateString('en-GB');
