    ...
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-striped custom-table mb-0 leaveadmintable">
                ...
                <tbody>
                    @if (isset($apply_leaves) && $apply_leaves)
                        @foreach ($apply_leaves as $apply_leave)
                            <tr>
                                ...
                                <td style="white-space: normal !important">
                                    @foreach ($apply_leave->adjust_leaves as $adLeave)
                                    ...
                                    <div class="dropdown action-label">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="changeApproveStatus('Approved', '{{ $apply_leave->id }}', '{{ route('employee.other.leave.application.update.status') }}?apply_leave_id={{ $apply_leave->id }}&status={{ \App\Enums\ApprovedStatusEnum::Approved->value }}');"><i
                                                    class="fa fa-dot-circle-o text-success"></i> Approved</a>
                                            <a class="dropdown-item" href="#"
                                                onclick="changeApproveStatus('Declined', '{{ $apply_leave->id }}', '{{ route('employee.other.leave.application.update.status') }}?apply_leave_id={{ $apply_leave->id }}&status={{ \App\Enums\ApprovedStatusEnum::Declined->value }}');"><i
                                                    class="fa fa-dot-circle-o text-danger"></i> Declined</a>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="#"
                                                onclick="deleteLeaveFunction('{{ route('employee.other.leave.application.delete', $apply_leave->id) }}');"><i
...
@include('employee.employee-applications.components.modals.statusmodal')
@include('employee.employee-applications.components.modals.deletemodal')
@include('employee.employee-applications.components.modals.viewleave')
