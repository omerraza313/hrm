...
<div class="header">
    ...
    <div class="header-left">
        <a href="{{ route('employee.dashboard') }}" class="logo">
            ...
            <img src="{{ asset('images/auth/newlogo2.png') }}" width="200" height="110" />
        </a>
    </div>
    <!-- /Logo -->
    ...
    <div class="page-title-box">
        {{-- <h3>Novita HRMS</h3> --}}
        {{-- <img src="{{ asset('assets/img/newlogo.png') }}" width="110" height="110" /> --}}
        <a href="{{ route('employee.dashboard') }}" class="text-white">
            <h3>HRMS</h3>
        </a>
    </div>
    <!-- /Header Title -->
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img"><img
                        src="{{ auth()->user()->image ? asset('images/employee/') . '/' . auth()->user()->image : asset('assets/img/profiles/avatar-02.jpg') }}"
                        alt="">
                    <span class="status online"></span></span>
                <span>{{ auth()->user()->first_name . ' ' . auth()->user()->last_name }}</span>
            </a>
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('employee.profile.view') }}">My Profile</a>
