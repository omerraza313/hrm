        ...
        <div class="row">
            <div class="col-md-5">
                <div class="profile-info-left">
                    ...
                    <div class="small doj text-muted">Role : {{ $roles_string }}</div>
            ...
            <li>
                ...
                <div class="text">
                    ...
                    <a href="{{ route('profile.view', $employee->employee_details->manager->id) }}">
...
<div class="pro-edit">
    ...
    <a onclick="openEditProfileModal('{{ json_encode($employee) }}')" class="edit-icon" href="#"><i
...
<script>
    $(document).ready(function() {
        ...
        let designation_id = {
            {
                $employee - > employee_details - > designation_id
            }
        };
        if (departmentId) {
            ...
            $.get("https://localhost/vibeh" + "/admin/get-designation/" + departmentId, function(data2) {
                console.clear();
