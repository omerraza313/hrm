        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('profile.info') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <x-field-validation errorname="pro_image" />
                            <div class="profile-img-wrap edit-img">
                                ...
                                <div class="fileupload btn">
                                    ...
                                    <input class="upload" type="file" name="pro_image">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $dob = $employee->employee_details->dob;
                                            if (strpos($dob, '-')) {
                                                $utcTime = \Carbon\Carbon::createFromFormat('Y-m-d', $dob);
                                                $dob = $utcTime->format('d/m/Y');
                                            }
                                        @endphp
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="pro_dob"
                                                value="{{ old('pro_dob') ?? $dob }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="pro_designation" id="pro_designation">
                                        ...
                                        @if (isset($designations->designations) && $designations->designations)
                                            @foreach ($designations->designations as $designation)
                                                <option value="{{ $designation->id }}"
                                                        @if ((old('pro_department') ?? $employee->employee_details->designation_id) == $designation->id) selected @endif>
