<div class="card-body">
    <h3 class="card-title">Experience
        @if (!$employee->deleted_at)
            <a href="#" class="edit-icon" data-bs-toggle="modal" data-bs-target="#experience_info"><i
        ...
        <ul class="experience-list">
            @if (isset($employee->experiences) && $employee->experiences)
                @foreach ($employee->experiences as $experience)
                    @php
                        $from_carbonDate = \Carbon\Carbon::createFromFormat('d/m/Y', $experience->from_date);

                        $from = $from_carbonDate->format('M Y');

                        $to_carbonDate = \Carbon\Carbon::createFromFormat('d/m/Y', $experience->to_date);
                    ...
                    <li>
                        ...
                        <div class="experience-content">
                            <div class="timeline-content">
                                <a href="#/" class="name">{{ $experience->job_position }} at
