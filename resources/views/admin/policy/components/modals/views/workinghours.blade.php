...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input class="form-control timepicker" type="text" placeholder="--:-- --" name="add_policy_shift_start"
            id="add_policy_shift_start" value="{{ old('add_policy_shift_start', isset($policy) ? $policy->working_settings->shift_start : '') }}">
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input class="form-control" type="number" placeholder="In minutes" name="add_policy_late_c_l_t"
            value="{{ old('add_policy_late_c_l_t', isset($policy) ? $policy->working_settings->late_c_l_t : '') }}">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="add_policy_e_a_p">
            ...
            @foreach (\App\Helpers\PolicyHelper::early_arrival_policy() as $key => $early_arrival_policy)
                <option value="{{ $key }}" @if ($key == old('add_policy_e_a_p', isset($policy) ? $policy->working_settings->early_arrival_policy : '')) selected @endif>
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input class="form-control timepicker" type="text" placeholder="--:-- --" name="add_policy_shift_close"
            id="add_policy_shift_close" value="{{ old('add_policy_shift_close', isset($policy) ? $policy->working_settings->shift_close : '') }}">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="add_policy_force_timeout">
            ...
            @foreach (\App\Helpers\PolicyHelper::get_force_timeout() as $key => $time_out)
                <option value="{{ $key }}" @if ($key == old('add_policy_force_timeout', isset($policy) ? $policy->working_settings->force_timeout : '')) selected @endif>
                    {{ $time_out }}</option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="add_policy_timeout_policy">
            ...
            @foreach (\App\Helpers\PolicyHelper::get_timeout_policy() as $key => $timeout_policy)
                <option value="{{ $key }}" @if ($key == old('add_policy_timeout_policy', isset($policy) ? $policy->working_settings->timeout_policy : '')) selected @endif>
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input class="form-control" type="number" placeholder="Max value 999" name="add_policy_monthly_late_minute"
            value="{{ old('add_policy_monthly_late_minute', isset($policy) ? $policy->working_settings->late_minute_monthly_bucket : '') ?? 0 }}">
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input class="form-control" type="number" placeholder="Max value 4" name="add_policy_late_comers_penalty"
            value="{{ old('add_policy_late_comers_penalty', isset($policy) ? $policy->working_settings->late_comers_penalty : '') ?? 0 }}">
